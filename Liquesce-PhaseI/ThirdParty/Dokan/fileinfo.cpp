...
ULONG DokanFillFileStandardInfo(
...
ULONG DokanFillFilePositionInfo(
   ...
   PEVENT_CONTEXT				EventContext)
{
   ...
   // FileNameInformation
   AllInfo->NameInformation.FileNameLength = EventContext->File.FileNameLength;
   RtlCopyMemory(&(AllInfo->NameInformation.FileName[0]), EventContext->File.FileName, EventContext->File.FileNameLength);
...
ULONG DokanFillFileNameInfo(
   PFILE_NAME_INFORMATION		NameInfo,
   PBY_HANDLE_FILE_INFORMATION	/*FileInfo*/,
   PULONG						RemainingLength,
   PEVENT_CONTEXT				EventContext)
{
   if (*RemainingLength < sizeof(FILE_NAME_INFORMATION) + EventContext->File.FileNameLength)
   {
         return STATUS_BUFFER_OVERFLOW;
   }
...
ULONG DokanFillFileAttributeTagInfo(
...
ULONG DokanFillNetworkOpenInfo(
   ...
   PDOKAN_INSTANCE		DokanInstance)
{
   ...
   {
      ULONG remainingLength( eventInfo->BufferLength );
